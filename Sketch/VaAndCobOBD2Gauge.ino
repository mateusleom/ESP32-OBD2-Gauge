...
const String pidConfig[7][9] = {
  ...
  { "CVT Temp"   , "`C" , "2210D2", "5", "60" , "110" , "3", "0", "99" },  //"CVT Temp", "`C", "22E1C", "5", "60", "110", "3", "0", "105" },  //0 formula era 5 antes //pid era 221E1C antes
  { "Coolant"    , "`C" , "0105"  , "1", "70" , "120" , "1", "0", "105" },    //1
  //{ "Catalyst" , "`C" , "013C"  , "4", "200", "800" , "2", "0", "760" },  //2
  { "Short Trim" , "%"  , "0106"  , "6", "-100", "100", "0", "1", "760" },  //2
  { "Water Level", "IO" , "013C"  , "8", "0"  , "101" , "2", "0", "60" },  //2
  { "ENG SPD"    , "rpm", "010C"  , "3", "0"  , "5000", "3", "0", "9000" },  //4
  //{ "AFR"        , "A/F", "0134"  , "2", "0"  , "120" , "1", "1", "200" },        //5
  { "Long Trim" , "%"  , "0107"   , "6", "-100", "100" , "0", "1", "760" },  //2
  { "Oil Press"  , "bar", "0105"  , "7", "0"  , "200" , "0", "1", "200" }   //6
};

//barometric pressure "0133"  turbo boost = map - bp;
//hold warning value
String warningValue[7] = { "99", "105", "200", "60", "9000", "200", "99" };
...
recent_client_addr : {0x00,0x00,0x00,0x00,0x00,0x00} array of bytes[6]
  ...
  layout = 2;  //pref.getUShort("layout",0);//load layout setting from NVR
